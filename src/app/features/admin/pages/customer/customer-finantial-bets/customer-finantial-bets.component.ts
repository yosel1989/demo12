...
@Component({
  selector: 'app-customer-finantial-bets',
  imports: [TabsModule],
  templateUrl: './customer-finantial-bets.component.html',
  styleUrl: './customer-finantial-bets.component.scss',
  providers: []
})
export class CustomerFinantialBetsComponent implements OnInit, AfterViewInit{
